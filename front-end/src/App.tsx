      ...
      <main className='flex-1 p-6 flex gap-4'>
        <div className='flex flex-col flex-1 gap-4'>
          <div className='grid grid-rows-2 gap-4 flex-1'>
            ...
            <Textarea
              className='resize-none p-4 leading-relaxed'
              placeholder='Resultado gerado pela IA...' readOnly value={completion} />
          </div>
        ...
        <aside className='w-80 space-y-6'>
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className='space-y-2'>
              ...
              <span className='block text-xs text-muted-forenground italic'>
            ...
            <div className='space-y-4'>
              ...
              />
              <span className='block text-xs text-muted-forenground italic leading-relaxed'>
